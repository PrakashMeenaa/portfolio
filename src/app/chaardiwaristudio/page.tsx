...
const page = () => {
  return (
    <div className="text-primary bg-gradient-to-b from-second to-[#796a63] flex flex-col lg:flex-row h-max justify-around items-center mt-10 p-10">
      <div className="screen my-[1.5rem] ">
        <Image src="/chaardiwaristudio/desktop.webp" alt="" className=" xl:bottom-[-1300px]" />
      </div>
      <div className=" h-max  w-screen flex flex-col gap-3 items-center my-[1.5rem] ">
        ...
        <div className="bg-opacity-5 bg-primary shadow-lg scale-[90%] p-7 flex flex-col rounded-2xl gap-3">
          <div className="max-w-4xl mx-auto p-4 text-white">
            <h1 className="text-5xl font-bold mb-4 text-center uppercase text-[#fffae6]">Chaar Diwari Studio</h1>
            ...
            <div className="overflow-y-auto max-h-[550px]">
              ...
              <section className="mb-8">
                ...
                <div className="">
                  <h3 className="text-2xl font-semibold mb-2 text-[#e8d3b8]">Portfolio Page</h3>
                ...
                <div className="mb-6">
                  <h3 className="text-2xl font-semibold mb-2 text-[#e8d3b8]">Services Page</h3>
