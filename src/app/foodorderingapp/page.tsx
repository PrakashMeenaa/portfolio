  ...
  return (
    ...
    <div className="overflow-y-auto max-h-[550px]">
        ...
        <section className="mb-8">
            ...
            <div className="mb-6">
                <h3 className="text-xl md:text-2xl font-semibold mb-2 text-[#e8d3b8]">Menu Page</h3>
                ...
                <div className="overflow-scroll max-h-[450px] h-max rounded-xl my-6">
                    <Image src='/foodorderingapp/menu.webp' alt="MenuPage"   width="0" height="0" sizes="100vw" className="h-max w-full object-cover rounded-xl"/>
                </div>
            </div>

            <div className="mb-6">
                <h3 className="text-xl md:text-2xl font-semibold mb-2 text-[#e8d3b8]">Cart Page</h3>
                ...
                <div className="overflow-scroll max-h-[450px] h-max rounded-xl my-6">
                    <Image src='/foodorderingapp/cart.webp' alt="Cart Page" width="0" height="0" sizes="100vw" className="h-max w-full object-cover rounded-xl"/>
                </div>
            </div>

            <div className="mb-6">
                <h3 className="text-xl md:text-2xl font-semibold mb-2 text-[#e8d3b8]">Profile Page</h3>
                ...
                <div className="overflow-scroll max-h-[450px] h-max rounded-xl my-6">
                    <Image src='/foodorderingapp/profile.webp' alt="Profile Page"  width="0" height="0" sizes="100vw" className="h-max w-full object-cover rounded-xl"/>
                </div>
            </div>

            <div className="mb-6">
                <h3 className="text-xl md:text-2xl font-semibold mb-2 text-[#e8d3b8]">Register Page</h3>
                ...
                <div className="overflow-scroll max-h-[450px] h-max rounded-xl my-6">
                    <Image src='/foodorderingapp/register.webp' alt="Register Page" width="0" height="0" sizes="100vw"  className="h-max w-full object-cover rounded-xl"/>
                </div>
            </div>
        </section>
